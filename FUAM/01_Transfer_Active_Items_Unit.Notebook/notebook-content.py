...
# Filter out id 'bd9136d2-e45a-463d-b9be-8d1a10717acb', which causes duplicates at some customers
silver_df = silver_df.filter(silver_df.id != 'bd9136d2-e45a-463d-b9be-8d1a10717acb')
