...
dataset = "New_DP_700_Semantic_Model" # Enter the name or ID of the semantic model
workspace = "DP_700_DEV" # Enter the workspace name or ID in which the semantic model exists
